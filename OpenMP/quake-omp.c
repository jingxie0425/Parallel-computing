 ...
 * Optimized by Jing Xie, 08 Mar 2021
 */
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
...
/* Redefine nodekind to be 1 for all surface nodes */
  /* Parallel the for loop. Divides loop iterations between the spawned threads.
   * */
...
/* Time integration loop */
  ...
  /* Parallel the for loop. Divides loop iterations between the spawned threads.
   * collapse is used to partition the nested loops. */
...
#pragma omp parallel for collapse(2) shared(w2)
  ...
  /* Initializations */
/* threads are spawned and then the for loop is partitioned to threads */
#pragma omp parallel
  {
...
#pragma omp for
  ...
  /* Parallel the for loop. Divides loop iterations between the spawned threads.
   * collapse is used to partition 2 more nested loops. */
